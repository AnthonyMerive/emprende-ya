                ...
                <ThemeProvider theme={theme} >
                    <Container component="main" maxWidth="md" >
                        ...
                        >
                            ...
                            <Typography sx={{ fontWeight: "bold", mt: 2, textAlign: "center", fontSize: "20px", fontFamily: "Nova Round"}} component="h1" variant="h4">
                            ...
                            <Box component="form" noValidate sx={{
                                ...
                                <Box sx={{ mt: 2, textAlign: "justify", fontSize: "14px" }}>
                                    <hr />
                                    <br />
                                    <Typography sx={{fontFamily: "Nova Round"}}>Si desea enviar un mensaje, deje informacion útil para que nuestro emprendedor {props.displayName} lo contacte.
                                    Recuerde que tambien puede contactarlo a traves del correo electronico <strong>{props.correo}</strong>.</Typography>
                                </Box>
